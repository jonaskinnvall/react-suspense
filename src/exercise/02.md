...
- Render as you fetch, meaning: get the data as soon as you have the information
  you need for the data
- Converting a component to "render as you fetch" instead of fetching on render
  by using suspense (together with error boundary)
- How the positioning of the Suspense and Error Boundary components affect the
  UX greatly since it can throw off the look of the page very much wiht bad
  placement
  - E.g. rendering the suspense or error boundary in place of the whole app
    instead of just a small and relevant area of the layout
