...
- How useful it can be to refactor suspense functionality int oa custom hook
  - Cleans up tons of code from components
  - Given it's wrapped in a Suspense, the hook can be used elsewhere throughout
    the app
