...
- SuspenseList and how it can be used to coordinate the order our suspending
  components display to improve our UX
  - This is mostly useful in larger apps with a lot of lazy loaded components
    that are fetching at the same time as a lot of different data (which all can
    "arrive" at different times and not in the "correct" order)
- I think the SuspenseList has been deprecated in React 18 though
  - Would be a good idea to look through docs further about this
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Suspense%20%F0%9F%94%80&e=07%3A%20Coordinate%20Suspending%20components%20with%20SuspenseList&em=).
